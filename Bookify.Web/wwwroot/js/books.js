$(document).ready(function () {
    ...
    datatable = $('#Books').DataTable({
        ...
        columns: [
            ...
            { "data": "hall", "name": "Hall" },
            { "data": "bookCategories", "name": "Categories", "orderable": false },
            {
            ...
            <div class="menu-item px-3">
                <a class="menu-link px-3 " data-title="EditBook" href="/Books/Edit/${row.id}">Edit</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="javascript:;" class="menu-link px-3 js-toggle-status" data-url="/Books/ToggleStatus/${row.id}">Toggle Status</a>
            </div>
            <!--end::Menu item-->
